...
## 
#c.ExtractOutputPreprocessor.extract_output_types = {'image/png', 'application/pdf', 'image/svg+xml', 'image/jpeg'}
...
c.TagRemovePreprocessor.remove_single_output_tags.add("hide_output")
