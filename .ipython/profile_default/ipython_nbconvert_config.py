...
# a config file.
# 
# - prevent_list_blocks - strip_dollars - citation2latex - add_anchor -
# strip_files_prefix - highlight2latex - ascii_only - wrap_text - html2text -
# ipython2python - get_lines - markdown2html - escape_latex - markdown2latex -
# markdown2rst - posix_path - add_prompts - ansi2latex - indent - ansi2html -
# path2url - highlight2html - strip_ansi - comment_lines - filter_data_type
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'image/jpeg', 'application/pdf', 'image/png', 'image/svg+xml'}
