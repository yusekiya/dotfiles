...
setkey("n", "<leader>s+", "<C-w>+", { desc = "Increase height" })
setkey("n", "<leader>s-", "<C-w>-", { desc = "Decrease height" })
setkey("n", "<leader>s>", "<C-w>>", { desc = "Increase width" })
setkey("n", "<leader>s<", "<C-w><", { desc = "Decrease width" })
